...
describe('error handling', () => {
    test('nonexistent mark name', async () => {
        ...
        try {
            ...
            expect(e.message).toContain('@@ source1.txt mark: nonexistentMark '); //line
    ...
    test('empty mark name', async () => {
        ...
        try {
            ...
            expect(e.message).toContain('mark-empty.txt:2'); //file&line info
            expect(e.message).toContain('@@ source1.txt mark:  '); //line
    ...
    test('invalid mark name (contains forbidden characters)', async () => {
        ...
        try {
            ...
            expect(e.message).toContain('@@ source-invalid-mark-name.txt mark: mark1 '); //line
            expect(e.message).toContain('Invalid mark name'); //err
    ...
    test('use mark from file that contains no marks', async () => {
        ...
        try {
            ...
            expect(e.message).toContain('@@ source-with-no-marks.txt mark: mark1 '); //line
    ...
    test('invalid mark name in input file', async () => {
        ...
        try {
            ...
            expect(e.message).toContain('@@ source1.txt mark: *invalidMark '); //line
            expect(e.message).toContain('Invalid mark name'); //err
        }
    });
