...
const first_rest_matcher_1 = require("../../src/utils/first_rest_matcher");
let wordMatcher;
beforeEach(() => {
    wordMatcher = (0, first_rest_matcher_1.createFirstRestMatcher)(/\w+/);
});
describe('HeadTailMatcher', () => {
    ...
    test('matches alternate construct', () => {
        const matcher = (0, first_rest_matcher_1.createFirstRestMatcher)(/run|stop/);
    ...
    test('create matcher from string', () => {
        const idleMatcher = (0, first_rest_matcher_1.createFirstRestMatcher)('idle');
        const lineIdle = '   idle script1 10 20';
...
//# sourceMappingURL=first_rest_matcher.test.js.map