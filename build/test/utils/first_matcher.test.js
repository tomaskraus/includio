...
const first_matcher_1 = require("../../src/utils/first_matcher");
let wordFirstMatcher;
beforeEach(() => {
    wordFirstMatcher = (0, first_matcher_1.createFirstMatcher)(/\w+/);
});
describe('HeadTailMatcher', () => {
    ...
    test('matches alternate construct', () => {
        const matcher = (0, first_matcher_1.createFirstMatcher)(/run|stop/);
    ...
    test('create matcher from string', () => {
        const idleMatcher = (0, first_matcher_1.createFirstMatcher)('idle');
        const lineIdle = '   idle script1 10 20';
...
//# sourceMappingURL=first_matcher.test.js.map