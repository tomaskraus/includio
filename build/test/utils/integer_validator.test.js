...
const integer_validator_1 = require("../../src/utils/integer_validator");
const validateInt = (0, integer_validator_1.createIntegerValidator)();
const validateIntMinMinus1Max10 = (0, integer_validator_1.createIntegerValidator)(-1, 10);
describe('IntegerValidator', () => {
    test('validates proper integer value', () => {
        expect(validateInt(' 5  ')).toEqual(5);
    });
    test('minValue: validates proper integer value', () => {
        const validateIntMin1 = (0, integer_validator_1.createIntegerValidator)(1);
        expect(validateIntMin1(' 90')).toEqual(90);
        expect(validateIntMin1(' 1')).toEqual(1);
    });
    test('maxValue: validates proper integer value', () => {
        const validateIntMax10 = (0, integer_validator_1.createIntegerValidator)(undefined, 10);
...
//# sourceMappingURL=integer_validator.test.js.map