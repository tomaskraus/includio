...
const first_and_rest_matcher_1 = require("../../src/utils/first_and_rest_matcher");
let matcher;
beforeEach(() => {
    matcher = (0, first_and_rest_matcher_1.createFirstAndRestMatcher)(/\w+/);
});
describe('firstAndRestMatcher', () => {
    ...
    test('matches alternate construct', () => {
        const matcher = (0, first_and_rest_matcher_1.createFirstAndRestMatcher)(/run|stop/);
    ...
    test('create matcher from string', () => {
        const matcher = (0, first_and_rest_matcher_1.createFirstAndRestMatcher)('idle');
...
//# sourceMappingURL=first_and_rest_matcher.test.js.map